  ...
  return knex('posts').del()
    .then(function () {
      return Promise.all([
        ...
        knex('posts')
        .insert({title: 'Pancakes', 
                description: 'yummmmmmmmmmmmmmmmmmmmm ', 
                URL: 'https://www.allrecipes.com/recipe/21014/good-old-fashioned-pancakes/' }),

        knex('posts')
        .insert({title: 'Samsung Fold Phone', 
        ...
        knex('posts')
        .insert({title: 'Chocolate Fudge Cake', 
